...
def parse_args():
    ...
    parser.add_argument(
        "--sampled-qids", type=str, default="", help="Sampled qids used for filtering the queries, if not specified a new sampling will happen"
    )
    parser.add_argument(
        "--output-dir",
        type=str,
...
def main(args):
    ...
    if args.sampled_qids:
        with open(args.sampled_qids, 'r') as f:
